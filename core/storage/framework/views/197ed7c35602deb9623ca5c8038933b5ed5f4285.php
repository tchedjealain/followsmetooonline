<?php
    ...
    $testimonialElements = getContent('testimonial.element', null, false, true)->unique('id');
?>
                                    ...
                                    <div class="client-content">
                                        <div class="client-details">
                                            <div class="client-ratings">
                                                <?php
                                                    $ratting = isset($item->data_values->Ratting_out_of_five) ? $item->data_values->Ratting_out_of_five : 0;
                                                ?>
                                        ...
                                        <div class="client-bottom">
                                            ...
                                            <div class="client-title">
                                                ...
                                                <span class="sub-title"><?php echo e(__(@$item->data_values->designation)); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/sections/testimonial.blade.php ENDPATH**/ ?>