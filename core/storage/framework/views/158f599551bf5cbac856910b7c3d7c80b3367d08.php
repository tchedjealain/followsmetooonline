                    ...
                    <div class="row m-0">
                        <div class="col-lg-6 p-0">
                            <div class="change-catagory-area">
                                <h4 class="title">
                                    <?php echo app('translator')->get('Vous avez déjà un compte?'); ?>
                                </h4>
                                <a href="<?php echo e(route('user.login')); ?>"
                                    class="btn--base-active account-control-button"><?php echo app('translator')->get('Connectez-vous ici'); ?></a>
                            </div>
                        </div>

                        <div class="col-lg-6 ">
                            <div class="register-form-area common-form-style bg-one create-account">
                                <h4 class="title"><?php echo app('translator')->get('Créez votre compte'); ?></h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label"><?php echo app('translator')->get('Nom Utilisateur'); ?></label>
                                                <input type="text" class="form-control form--control checkUser"
                                                    name="username" value="<?php echo e(old('username')); ?>" required
                                                    placeholder="<?php echo app('translator')->get('Nom Utilisateur'); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label"><?php echo app('translator')->get('Adresse E-Mail'); ?></label>
                                                <input type="email" class="form-control form--control checkUser"
                                                    placeholder="<?php echo app('translator')->get('Adresse E-Mail'); ?>" name="email"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label"><?php echo app('translator')->get('Pays'); ?></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label"><?php echo app('translator')->get('Numéro Téléphone'); ?></label>
                                                <div class="input-group ">
                                                    ...
                                                    <input type="number" name="mobile" value="<?php echo e(old('mobile')); ?>"
                                                        ...
                                                        placeholder="<?php echo app('translator')->get('Numéro Téléphone'); ?>" required>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label"><?php echo app('translator')->get('Mot De Passe'); ?></label>
                                                <input type="password" class="form-control form--control" name="password"
                                                    placeholder="<?php echo app('translator')->get('Mot De Passe'); ?>" required>
                                                <?php if($general->secure_password): ?>
                                                    <div class="input-popup">
                                                        <p class="error lower"><?php echo app('translator')->get('1 lettre minuscule minimum'); ?></p>
                                                        <p class="error capital"><?php echo app('translator')->get('1 majuscule minimum'); ?></p>
                                                        <p class="error number"><?php echo app('translator')->get('1 numéro minimum'); ?></p>
                                                        <p class="error special"><?php echo app('translator')->get('1 caractère spécial minimum'); ?></p>
                                                        <p class="error minimum"><?php echo app('translator')->get('Mot de passe à 6 caractères'); ?></p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label"><?php echo app('translator')->get('Confirmez Mot De Passe'); ?></label>
                                                <input type="password" class="form-control form--control"
                                                    name="password_confirmation" required placeholder="<?php echo app('translator')->get('Confirmez Mot De Passe'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
...
<?php endif; ?>
                                    ...
                                    <?php if($general->agree): ?>
                                        <div class="form-group form-checkbox mb-3">
                                            <input type="checkbox" id="agree" <?php if(old('agree')): echo 'checked'; endif; ?>
                                                name="agree" required>
                                            <label for="agree"><?php echo app('translator')->get('Je suis d\'accord avec'); ?></label>
                                    ...
                                    <div class="form-group mt-3">
                                        <button type="submit" id="recaptcha" class="btn btn--base w-100">
                                            <?php echo app('translator')->get('Créer Un Compte'); ?></button>
                                    </div>
                                    <p class="mt-3"><?php echo app('translator')->get('Vous avez déjà un compte?'); ?>
                                        <a href="<?php echo e(route('user.login')); ?>" class="text--base">
                                            <?php echo app('translator')->get('Connexion'); ?>
                                        </a>
                                    </p>
                                </form>
                            </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/user/auth/register.blade.php ENDPATH**/ ?>