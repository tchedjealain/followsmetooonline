                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mrb-30">
                            <div class="news-item">
                                <div class="news-thumb">
                                    <img src="<?php echo e(getImage('assets/images/frontend/blog/thumb_' . @$item->data_values->image, '480x280')); ?>" alt="<?php echo app('translator')->get('blog'); ?>">
                                </div>
                                <div class="news-content">
                                    ...
                                    <div class="news-btn">
                                        <a class="custom-btn" href="<?php echo e(route('blog.details', [$item->id, slug($item->data_values->title)])); ?>"><?php echo app('translator')->get('EN SAVOIR PLUS'); ?> <i class="las la-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/blog.blade.php ENDPATH**/ ?>