              ...
              <div class="row gy-4">
                  <div class="col-lg-4 col-sm-8">
                      <div class="footer-widget widget-menu">
                          <div class="footer-logo">
                              <h3 class="widget-title"><?php echo app('translator')->get('A Propos'); ?></h3>
                  ...
                  <div class="col-lg-2 col-sm-6">
                      <div class="footer-widget">
                          <h3 class="widget-title"><?php echo app('translator')->get('Liens Rapides'); ?></h3>
                          <ul>
                              ...
                              <li><a href="<?php echo e(route('api.documentation')); ?>"><?php echo app('translator')->get('Documentation API'); ?></a></li>
                          </ul>
                      </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                      <div class="footer-widget">
                          <h3 class="widget-title"><?php echo app('translator')->get('Politiques'); ?></h3>
                          <ul>
                              <?php
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="footer-widget widget-menu">
                          ...
                          <ul class="footer-contact-list">
                              ...
                              <li><?php echo app('translator')->get('Appellez'); ?> <?php echo e(@$addressContent->data_values->phone); ?></li>
                              <li><a
...
<?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/partials/footer.blade.php ENDPATH**/ ?>