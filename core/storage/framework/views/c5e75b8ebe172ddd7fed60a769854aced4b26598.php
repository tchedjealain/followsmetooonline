    ...
    <div class="row mb-none-30 justify-content-center">
        <div class="col-xl-4 col-md-6 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted"><?php echo app('translator')->get('Dépôt Via'); ?> <?php echo e(__(@$deposit->gateway->name)); ?></h5>
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Numéro Transaction'); ?>
                            <span class="fw-bold"><?php echo e($deposit->trx); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Nom D\'utilisateur'); ?>
                            <span class="fw-bold">
                                <a
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold"><?php echo e(showAmount($deposit->final_amo)); ?>
        ...
        <?php if($details || $deposit->status == Status::PAYMENT_PENDING): ?>
            <div class="col-xl-8 col-md-6 mb-30">
                <div class="card b-radius--10 overflow-hidden box--shadow1">
                    <div class="card-body">
                        <h5 class="card-title mb-50 border-bottom pb-2"><?php echo app('translator')->get('Informations sur le dépôt de l\'utilisateur'); ?></h5>
                        <?php if($details != null): ?>
                                            ...
                                            <?php elseif($val->type == 'file'): ?>
                                                <?php if($val->value): ?>
                                                    <a href="<?php echo e(route('admin.download.attachment', encrypt(getFilePath('verify') . '/' . $val->value))); ?>"
                                                        class="me-3"><i class="fa fa-file"></i> <?php echo app('translator')->get('Pièce jointe'); ?> </a>
                                                <?php else: ?>
                                                    <?php echo app('translator')->get('Pas de fichier'); ?>
                                                <?php endif; ?>
                                            <?php else: ?>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <button class="btn btn-outline--success btn-sm ms-1 confirmationBtn"
                                        ...
                                        data-question="<?php echo app('translator')->get('Êtes-vous sûr d\'approuver cette transaction?'); ?>"><i class="las la-check-double"></i>
                                        <?php echo app('translator')->get('Approuver'); ?>
                                    </button>
                                    ...
                                    <button class="btn btn-outline--danger btn-sm ms-1 rejectBtn"
                                        ...
                                        <?php echo app('translator')->get('Rejeter'); ?>
                                    </button>
                                </div>
                            </div>
                        <?php endif; ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo app('translator')->get('Refuser la confirmation de dépôt'); ?></h5>
                ...
                <form action="<?php echo e(route('admin.deposit.reject')); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <p><?php echo app('translator')->get('Êtes-vous sûr de'); ?> <span class="fw-bold"><?php echo app('translator')->get('rejeter'); ?></span> <span
                                class="fw-bold withdraw-amount text--success"></span> <?php echo app('translator')->get('dépôt de'); ?> <span
                                class="fw-bold withdraw-user"></span>?</p>

                        <div class="form-group">
                            <label class="mt-2"><?php echo app('translator')->get('Raison du rejet'); ?></label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/admin/deposit/detail.blade.php ENDPATH**/ ?>