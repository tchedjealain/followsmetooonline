    ...
    <div class="navbar__left">
        ...
        <form class="navbar-search">
            <input type="search" name="#0" class="navbar-search-field" id="searchInput" autocomplete="off"
                placeholder="<?php echo app('translator')->get('Rechercher ici...'); ?>">
                ...
                <div class="dropdown-menu dropdown-menu--md p-0 border-0 box--shadow1 dropdown-menu-right">
                    <div class="dropdown-menu__header">
                        ...
                        <?php if($adminNotificationCount > 0): ?>
                            <p><?php echo app('translator')->get('Vous avez'); ?> <?php echo e($adminNotificationCount); ?> <?php echo app('translator')->get('notification non lue'); ?></p>
                        <?php else: ?>
                            <p><?php echo app('translator')->get('Aucune notification non lue trouvée'); ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="dropdown-menu__footer">
                        <a href="<?php echo e(route('admin.notifications')); ?>" class="view-all-message"><?php echo app('translator')->get('Afficher toutes les notifications'); ?></a>
                    </div>
                </div>
            </li>
...
<!-- navbar-wrapper end -->
<?php /**PATH /home/zubqbcmf/app/core/resources/views/admin/partials/topnav.blade.php ENDPATH**/ ?>