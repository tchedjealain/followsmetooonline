        ...
        <div class="row justify-content-center ml-b-30">
            <div class="col-lg-6 mrb-30">
                <div class="about-thumb">
                    <img src="<?php echo e(getImage('assets/images/frontend/about_1/' . @$aboutContent->data_values->image, '520x500')); ?>"
                        alt="about">
                </div>
            </div>
            <div class="col-lg-6 mrb-30">
                <div class="about-content">
                    <h2 class="title"><?php echo e(__(@$aboutContent->data_values->title)); ?></h2>
...
<!-- about-section end -->
<?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/sections/about_1.blade.php ENDPATH**/ ?>