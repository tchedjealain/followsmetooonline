                                ...
                                <div class="row mt-4">
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Nom De La Passerellee'); ?></label>
                                    ...
                                    <div class="col-xl-5 col-md-12">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Taux De Change'); ?></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('Montant Minimal'); ?></label>
                                                    <div class="input-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('Frais Fixes'); ?></label>
                                                    <div class="input-group">
                                                        <input type="number" step="any" class="form-control"
                                                            name="fixed_charge"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <h5 class="card-header bg--primary"><?php echo app('translator')->get('Instruction De Dépôt'); ?></h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            <div class="card-header bg--primary d-flex justify-content-between">
                                                <h5 class="text-white"><?php echo app('translator')->get('Données Utilisateur'); ?></h5>
                                                <button type="button"
                                                    class="btn btn-sm btn-outline-light float-end form-generate-btn"> <i
                                                        class="la la-fw la-plus"></i><?php echo app('translator')->get('Ajouter Nouveau'); ?></button>
                                            </div>
                                            <div class="card-body">
                                                        ...
                                                        <?php $__currentLoopData = $form->form_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="col-md-4">
                                                                <div class="card border mb-3" id="<?php echo e($loop->index); ?>">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="form-group">
                                                                            <label><?php echo app('translator')->get('Étiqueter'); ?></label>
                                                                            <input type="text"
                                                                                name="form_generator[form_label][]"
                                                                                class="form-control"
                                                                                value="<?php echo e($formData->name); ?>" readonly>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control"
                                                                                value="<?php echo e($formData->type); ?>" readonly>
                                                                        </div>
                                                                        <?php
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/admin/gateways/manual/edit.blade.php ENDPATH**/ ?>