    ...
    <div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-end">
                                <span class="text--small text-white"><?php echo app('translator')->get('Utilisateurs Total'); ?></span>
                ...
                <div class="card bg--success has-link box--shadow2">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-end">
                                <span class="text--small text-white"><?php echo app('translator')->get('Utilisateurs Actif'); ?></span>
                ...
                <div class="card bg--danger has-link box--shadow2">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-end">
                                <span class="text--small text-white"><?php echo app('translator')->get('Email Non Vérifié Users'); ?></span>
                ...
                <div class="card bg--red has-link box--shadow2">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-end">
                                <span class="text--small text-white"><?php echo app('translator')->get('Mobile Non Vérifié Users'); ?></span>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p><?php echo app('translator')->get('Dépôt Total'); ?></p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border--success btn-outline--success border border" href="<?php echo e(route('admin.deposit.list')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p><?php echo app('translator')->get('Dépôts En Attente'); ?></p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border--warning btn-outline--warning border border" href="<?php echo e(route('admin.deposit.pending')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p><?php echo app('translator')->get('Dépôts Rejetés'); ?></p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border--danger btn-outline--danger border border" href="<?php echo e(route('admin.deposit.rejected')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p><?php echo app('translator')->get('Frais De Dépôt'); ?></p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border--primary btn-outline--primary border border" href="<?php echo e(route('admin.deposit.list')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
        </div><!-- row end-->
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p><?php echo app('translator')->get('Commande Totale'); ?></p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border" href="<?php echo e(route('admin.orders.index')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--warning btn-outline--warning border" href="<?php echo e(route('admin.orders.pending')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--info btn-outline--info border" href="<?php echo e(route('admin.orders.processing')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
        ...
        <div class="row gy-4 mt-2">
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--success btn-outline--success border" href="<?php echo e(route('admin.orders.completed')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--danger btn-outline--danger border" href="<?php echo e(route('admin.orders.cancelled')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p><?php echo app('translator')->get('Commande Retournée'); ?></p>
                    </div>
                    <a class="widget-two__btn border--secondary btn-outline--secondary border" href="<?php echo e(route('admin.orders.refunded')); ?>"><?php echo app('translator')->get('Voir Tout'); ?></a>
                </div>
            </div><!-- dashboard-w1 end -->
        </div>
        <div class="row mb-none-30 mt-30">
            <div class="col-xl-6 mb-30">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo app('translator')->get('Dépôt Mensuel'); ?> (<?php echo app('translator')->get('12 Derniers Mois'); ?>)</h5>
            ...
            <div class="col-xl-6 mb-30">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo app('translator')->get('Transactions Report'); ?> (<?php echo app('translator')->get('30 Derniers Jours'); ?>)</h5>
        ...
        <div class="row mb-none-30 mt-5">
            <div class="col-xl-4 col-lg-6 mb-30">
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo app('translator')->get('Conexion Par Browser'); ?> (<?php echo app('translator')->get('30 Dern. Jours'); ?>)</h5>
            ...
            <div class="col-xl-4 col-lg-6 mb-30">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo app('translator')->get('Connexion Par Pays'); ?> (<?php echo app('translator')->get('30 Derniers Jours'); ?>)</h5>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo app('translator')->get('Instruction de réglage de la tâche Cron'); ?></h5>
                        <button class="close" data-bs-dismiss="modal" type="button" aria-label="Close">
                            <i class="las la-times"></i>
                        </button>
                    </div>
                    <div class="modal-body">
                        <h3 class="text--danger text-center"><?php echo app('translator')->get('Veuillez Définir La Tâche Cron Maintenant'); ?></h3>
                        <p class="lead">
                            <?php echo app('translator')->get('Pour automatiser le placement de la commande API, nous devons définir la tâche cron et nous assurer que la tâche cron s\'exécute correctement. Réglez le temps de Cron au minimum possible. Une fois toutes les 5 à 15 minutes est idéale, tandis qu\'une fois toutes les minutes est la meilleure option.'); ?> </p>
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-text copytext btn btn--primary copyBoard pt-2" id="copyBoard">
                                <?php echo app('translator')->get('Copié'); ?>
                            </span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>