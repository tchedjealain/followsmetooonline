            ...
            <div class="col-xxl-3 col-sm-6 mb-30">
                <div class="widget-two box--shadow2 b-radius--5 bg--success has-link">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p class="text-white"><?php echo app('translator')->get('Dépôt Réussi'); ?></p>
                    </div>
                </div><!-- widget-two end -->
            </div>
            <div class="col-xxl-3 col-sm-6 mb-30">
                <div class="widget-two box--shadow2 b-radius--5 bg--6 has-link">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p class="text-white"><?php echo app('translator')->get('Dépôt En Attente'); ?></p>
                    </div>
                </div><!-- widget-two end -->
            </div>
            <div class="col-xxl-3 col-sm-6 mb-30">
                <div class="widget-two box--shadow2 has-link b-radius--5 bg--pink">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p class="text-white"><?php echo app('translator')->get('Dépôt Rejeté'); ?></p>
                    </div>
                </div><!-- widget-two end -->
            </div>
            <div class="col-xxl-3 col-sm-6 mb-30">
                <div class="widget-two box--shadow2 has-link b-radius--5 bg--dark">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p class="text-white"><?php echo app('translator')->get('Dépôt Initié'); ?></p>
                    </div>
                </div><!-- widget-two end -->
            </div>
        <?php endif; ?>
                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('Initié'); ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.deposit.details', $deposit->id)); ?>"
                                                ...
                                                <i class="la la-desktop"></i> <?php echo app('translator')->get('Détails'); ?>
                                            </a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/admin/deposit/log.blade.php ENDPATH**/ ?>