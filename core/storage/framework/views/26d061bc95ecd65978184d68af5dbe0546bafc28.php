                    ...
                    <div class="row m-0 flex-wrap-reverse">
                        <div class="col-lg-6">
                            <div class="register-form-area common-form-style bg-one create-account">
                                <h4 class="title"><?php echo app('translator')->get('Connectez-vous'); ?></h4>
                                <form class="create-account-form register-form verify-gcaptcha" method="POST"
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-12 mb-3">
                                            <label class="form-label"><?php echo app('translator')->get('Nom Utilisateur ou E-mail'); ?></label>
                                            <input type="text" name="username" class="form--control"
                                                value="<?php echo e(old('username')); ?>" placeholder="<?php echo app('translator')->get('Nom Uutilisateur ou E-mail'); ?>" required>
                                        </div>
                                        <div class="col-lg-12 mb-3">
                                            <label class="form-label"><?php echo app('translator')->get('Mot De Passe'); ?></label>
                                            <input id="password" type="password" class="form--control" name="password"
                                                required autocomplete="current-password" placeholder="<?php echo app('translator')->get('Mot De Passe'); ?>">
                                        </div>
...
<?php endif; ?>
                                        ...
                                        <div class="col-lg-12 mb-3 text-center">
                                            <div class="checkbox-wrapper d-flex flex-wrap justify-content-between">
                                                <div class="checkbox-item">
                                                    ...
                                                    <label for="remember"><?php echo app('translator')->get('Se Souvenir De Moi'); ?></label>
                                                </div>


                                                <a href="<?php echo e(route('user.password.request')); ?>"
                                                    class="text--base"><?php echo app('translator')->get('Mot De Passe Oublié ?'); ?></a>

                                            </div>
                                        </div>

                                        <div class="col-lg-12">
                                            <button type="submit" class="submit-btn w-100"><?php echo app('translator')->get('Connexion'); ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="change-catagory-area">
                                <h4 class="title">
                                    <?php echo app('translator')->get('Nouveau ici ?'); ?>
                                </h4>
                                <a href="<?php echo e(route('user.register')); ?>"
                                    class="btn--base-active account-control-button"><?php echo app('translator')->get('Créer un compte'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function submitUserForm() {
            ...
            if (response.length == 0) {
                document.getElementById('g-recaptcha-error').innerHTML =
                    '<span style="color:red;"><?php echo app('translator')->get('Le champ Captcha est obligatoire.'); ?></span>';
                return false;
            }
            return true;
        }
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>