                        ...
                        <div class="row justify-content-center">
                            <div class="input-group mb-3">
                                <input class="form-control form--control" type="email" id="subscribe" name="email"
                                    value="<?php echo e(old('email')); ?>" placeholder="<?php echo app('translator')->get('Votre adresse e-mail'); ?>" required>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/sections/subscribe.blade.php ENDPATH**/ ?>