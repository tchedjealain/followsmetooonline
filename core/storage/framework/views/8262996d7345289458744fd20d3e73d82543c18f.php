...
<nav class="navbar-wrapper bg--dark">
    <div class="navbar__left">
        ...
        <form class="navbar-search">
            <input class="navbar-search-field" id="searchInput" name="#0" type="search" autocomplete="off" placeholder="<?php echo app('translator')->get('Rechercher...'); ?>">
...
<!-- navbar-wrapper end -->
<?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/partials/topnav.blade.php ENDPATH**/ ?>