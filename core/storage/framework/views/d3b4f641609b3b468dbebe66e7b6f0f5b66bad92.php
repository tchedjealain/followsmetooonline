                ...
                <form action="<?php echo e(route('admin.gateway.automatic.update', $gateway->code)); ?>" method="POST"
                    ...
                    <div class="card-body">
                        <div class="payment-method-item block-item">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="input-group d-flex flex-wrap justify-content-end width-375">
                                                <select class="newCurrencyVal ">
                                                    <option value=""><?php echo app('translator')->get('Sélectionner une devise'); ?></option>
                                                    <?php $__empty_1 = true; $__currentLoopData = $supportedCurrencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency => $symbol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <option value="<?php echo e($currency); ?>"
                                                            data-symbol="<?php echo e($symbol); ?>"><?php echo e(__($currency)); ?> </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                        <option value=""><?php echo app('translator')->get('Support de devise non disponible'); ?></option>
                                                    <?php endif; ?>

                                                </select>
                                                <button type="button"
                                                    class="btn btn--primary input-group-text newCurrencyBtn"
                                                    data-crypto="<?php echo e($gateway->crypto); ?>"
                                                    data-name="<?php echo e($gateway->name); ?>"><?php echo app('translator')->get('Ajouter Nouveau'); ?></button>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        value="<?php echo e(route($param->value)); ?>" readonly />
                                                    <button type="button" class="copyInput input-group-text"
                                                        title="<?php echo app('translator')->get('Copie'); ?>"><i class="fa fa-copy"></i></button>
                                                </div>
                            ...
                            <?php endif; ?>
                            <div class="payment-method-body mt-2">
                                <h4 class="mb-3"><?php echo app('translator')->get('Réglage Global pour'); ?> <?php echo e(__($gateway->name)); ?></h4>
                                <div class="row">
                                    <?php $__currentLoopData = $parameters->where('global', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $param): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-group col-lg-6">
                                            <label><?php echo e(__(@$param->title)); ?></label>
                                            <input type="text" class="form-control" name="global[<?php echo e($key); ?>]"
                                                value="<?php echo e(@$param->value); ?>" required />
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                                        ...
                                        <div class="content w-100 ps-0">
                                            <div class="d-flex justify-content-between">
                                                <div class="form-group">
                                                    <h4 class="mb-3"><?php echo e(__($gateway->name)); ?> -
                                                        <?php echo e(__($gatewayCurrency->currency)); ?></h4>
                                                    <input type="text" class="form-control"
                                                        name="currency[<?php echo e($currencyIndex); ?>][name]"
                                                        value="<?php echo e($gatewayCurrency->name); ?>" required />
                                                </div>
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn--danger confirmationBtn"
                                                        data-question="<?php echo app('translator')->get('Voulez-vous vraiment supprimer cette devise de passerelle ?'); ?>"
                                                        data-action="<?php echo e(route('admin.gateway.automatic.remove', $gatewayCurrency->id)); ?>">
                                                        <i class="la la-trash-o me-2"></i><?php echo app('translator')->get('Supprimer'); ?>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary mt-2">
                                                    <h5 class="card-header bg--primary"><?php echo app('translator')->get('Plage'); ?></h5>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label><?php echo app('translator')->get('Montant Minimum'); ?></label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control"
                                                                    name="currency[<?php echo e($currencyIndex); ?>][min_amount]"
                                                                    value="<?php echo e(getAmount($gatewayCurrency->min_amount)); ?>"
                                                                    required />
                                                                <div class="input-group-text"><?php echo e(__($general->cur_text)); ?>

                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label><?php echo app('translator')->get('Montant Maximum'); ?></label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control"
                                                                    name="currency[<?php echo e($currencyIndex); ?>][max_amount]"
                                                                    value="<?php echo e(getAmount($gatewayCurrency->max_amount)); ?>"
                                                                    required />
                                                                <div class="input-group-text"><?php echo e(__($general->cur_text)); ?>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary mt-2">
                                                    <h5 class="card-header bg--primary"><?php echo app('translator')->get('Frais'); ?></h5>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label><?php echo app('translator')->get('Frais Fixe'); ?></label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control"
                                                                    name="currency[<?php echo e($currencyIndex); ?>][fixed_charge]"
                                                                    value="<?php echo e(getAmount($gatewayCurrency->fixed_charge)); ?>"
                                                                    required />
                                                                <div class="input-group-text"><?php echo e(__($general->cur_text)); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <label><?php echo app('translator')->get('Frais en Pourcentage'); ?></label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control"
                                                                    name="currency[<?php echo e($currencyIndex); ?>][percent_charge]"
                                                                    value="<?php echo e(getAmount($gatewayCurrency->percent_charge)); ?>"
                                                                    required />
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary mt-2">
                                                    <h5 class="card-header bg--primary"><?php echo app('translator')->get('Devise'); ?></h5>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label><?php echo app('translator')->get('Devise'); ?></label>
                                                                    <input type="text"
                                                                        name="currency[<?php echo e($currencyIndex); ?>][currency]"
                                                                        class="form-control border-radius-5 "
                                                                        value="<?php echo e($gatewayCurrency->currency); ?>" readonly />
                                                                </div>

                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label><?php echo app('translator')->get('Symbole'); ?></label>
                                                                    <input type="text"
                                                                        name="currency[<?php echo e($currencyIndex); ?>][symbol]"
                                                                        class="form-control border-radius-5 symbl"
                                                                        value="<?php echo e($gatewayCurrency->symbol); ?>"
                                                                        data-crypto="<?php echo e($gateway->crypto); ?>" required />
                                                                </div>

                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label><?php echo app('translator')->get('Taux'); ?></label>
                                                            <div class="input-group">
                                                                <div class="input-group-text">1 <?php echo e(__($general->cur_text)); ?> =
                                                                </div>
                                                                <input type="number" step="any" class="form-control"
                                                                    name="currency[<?php echo e($currencyIndex); ?>][rate]"
                                                                    value="<?php echo e(getAmount($gatewayCurrency->rate)); ?>"
                                                                    required />
                                                                <div class="input-group-text"><span
                                                                        class="currency_symbol"><?php echo e(__($gatewayCurrency->baseSymbol())); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <?php $__currentLoopData = $parameters->where('global', false); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $param): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label><?php echo e(__($param->title)); ?></label>
                                                                            <input type="text" class="form-control"
                                                                                name="currency[<?php echo e($currencyIndex); ?>][param][<?php echo e($key); ?>]"
                                                                                value="<?php echo e($globalParameters->$key); ?>"
                                                                                required />
                                                                        </div>
                                                                    </div>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="payment-method-item child--item newMethodCurrency d-none">
                            ...
                            <div class="payment-method-header">
                                ...
                                <div class="content w-100 ps-0">
                                    <div class="d-flex justify-content-between">
                                        <div class="form-group">
                                            <h4 class="mb-3" id="payment_currency_name"><?php echo app('translator')->get('Nom'); ?></h4>
                                            <input disabled type="text" class="form-control"
                                                name="currency[<?php echo e($currencyIndex); ?>][name]" required />
                                        </div>
                                        <div class="remove-btn">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="number" step="any"
                                                            class="form-control"
                                                            name="currency[<?php echo e($currencyIndex); ?>][min_amount]" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="number" step="any"
                                                            class="form-control"
                                                            name="currency[<?php echo e($currencyIndex); ?>][max_amount]" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input disabled type="text"
                                                                name="currency[<?php echo e($currencyIndex); ?>][symbol]"
                                                                class="form-control border-radius-5 symbl"
                                                                ata-crypto="<?php echo e($gateway->crypto); ?>" disabled />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="number" step="any"
                                                            class="form-control"
                                                            name="currency[<?php echo e($currencyIndex); ?>][rate]" required />
                                                        <div class="input-group-text"><span
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/admin/gateways/automatic/edit.blade.php ENDPATH**/ ?>