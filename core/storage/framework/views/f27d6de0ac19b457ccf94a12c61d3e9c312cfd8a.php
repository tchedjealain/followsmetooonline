            ...
            <div class="col-md-8">
                ...
                <div class="card custom--card">
                    <div class="card-header">
                        <h5><?php echo app('translator')->get('Authorize Net'); ?></h5>
                    </div>
                    <div class="card-body">
...
<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(asset('assets/global/js/card.js')); ?>"></script>
...
<?php echo $__env->make($activeTemplate . 'layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/user/payment/Authorize.blade.php ENDPATH**/ ?>