        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="banner-content">
                    <h2 class="title"><?php echo app('translator')->get($pageTitle); ?></h2>
                    <div class="breadcrumb-area">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo app('translator')->get('Home'); ?></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get($pageTitle); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<!-- banner-section end -->
<?php /**PATH /home/zubqbcmf/app/core/resources/views/templates/basic/partials/breadcrumb.blade.php ENDPATH**/ ?>