        ...
        <div class="col-12">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content">
                            ...
                            <p class="text-white"><?php echo app('translator')->get('Solde'); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.report.transaction')); ?>?search=<?php echo e($user->username); ?>"
                            class="widget-two__btn"><?php echo app('translator')->get('Voir Tout'); ?></a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <div class="widget-two__content">
                            ...
                            <p class="text-white"><?php echo app('translator')->get('Dépôts'); ?></p>
                        </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <div class="widget-two__content">
                            ...
                            <p class="text-white"><?php echo app('translator')->get('Dépense Totale'); ?></p>
                        </div>
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two  box--shadow2 b-radius--5 bg--white">
                        ...
                        <a href="<?php echo e(route('admin.orders.index')); ?>?search=<?php echo e($user->username); ?>"
                            class="widget-two__btn border border--primary btn-outline--primary"><?php echo app('translator')->get('Voir Tout'); ?></a>
                    </div>
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two  box--shadow2 b-radius--5  bg--white">
                        ...
                        <a href="<?php echo e(route('admin.orders.pending')); ?>?search=<?php echo e($user->username); ?>"
                            class="widget-two__btn border border--warning btn-outline--warning"><?php echo app('translator')->get('Voir Tout'); ?></a>
                    </div>
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two  box--shadow2 b-radius--5 bg--white">
                        ...
                        <a href="<?php echo e(route('admin.orders.processing')); ?>?search=<?php echo e($user->username); ?>"
                            class="widget-two__btn border border--success btn-outline--success"><?php echo app('translator')->get('Voir Tout'); ?></a>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two  box--shadow2 b-radius--5 bg--white">
                        ...
                        <a href="<?php echo e(route('admin.orders.cancelled')); ?>?search=<?php echo e($user->username); ?>"
                            class="widget-two__btn border border--danger btn-outline--danger"><?php echo app('translator')->get('Voir Tout'); ?></a>
                    </div>
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two  box--shadow2 b-radius--5 bg--white">
                        ...
                        <a href="<?php echo e(route('admin.orders.refunded')); ?>?search=<?php echo e($user->username); ?>"
                            class="widget-two__btn border border--secondary btn-outline--secondary"><?php echo app('translator')->get('Voir Tout'); ?></a>
                    </div>
                </div><!-- dashboard-w1 end -->
            </div>
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                <div class="flex-fill">
                    <button data-bs-toggle="modal" data-bs-target="#addSubModal"
                        ...
                        <i class="las la-plus-circle"></i> <?php echo app('translator')->get('Solde'); ?>
                    </button>
                </div>
                ...
                <div class="flex-fill">
                    <button data-bs-toggle="modal" data-bs-target="#addSubModal"
                        ...
                        <i class="las la-minus-circle"></i> <?php echo app('translator')->get('Solde'); ?>
                    </button>
                </div>
                ...
                <div class="flex-fill">
                    <a href="<?php echo e(route('admin.report.login.history')); ?>?search=<?php echo e($user->username); ?>"
                        ...
                        <i class="las la-list-alt"></i><?php echo app('translator')->get('Connexions'); ?>
                    </a>
                </div>
                ...
                <div class="flex-fill">
                    <a href="<?php echo e(route('admin.users.login', $user->id)); ?>" target="_blank"
                        ...
                        <i class="las la-sign-in-alt"></i><?php echo app('translator')->get('Connectez-vous en tant qu\'utilisateur'); ?>
                    </a>
                </div>
                ...
                <div class="flex-fill">
                    <?php if($user->status == Status::USER_ACTIVE): ?>
                        <button type="button" class="btn btn--warning btn--gradi btn--shadow w-100 btn-lg userStatus"
                            ...
                            <i class="las la-ban"></i><?php echo app('translator')->get('Utilisateur Banni'); ?>
                        </button>
                    <?php else: ?>
                        <button type="button" class="btn btn--success btn--gradi btn--shadow w-100 btn-lg userStatus"
                            data-bs-toggle="modal" data-bs-target="#userStatusModal">
                            <i class="las la-undo"></i><?php echo app('translator')->get('Utilisateur débannir'); ?>
                        </button>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card mt-30">
                <div class="card-header">
                    <h5 class="card-title mb-0"><?php echo app('translator')->get('Information de'); ?> <?php echo e($user->fullname); ?></h5>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('admin.users.update', [$user->id])); ?>" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label"><?php echo app('translator')->get('Prénom'); ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Numéro Téléphone'); ?> </label>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Ville'); ?></label>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    <label><?php echo app('translator')->get('Région'); ?></label>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    <label><?php echo app('translator')->get('Pays'); ?></label>
                        ...
                        <div class="row">
                            <div class="form-group  col-xl-4 col-md-6 col-12">
                                <label><?php echo app('translator')->get('Email Vérification'); ?></label>
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                    data-bs-toggle="toggle" data-on="<?php echo app('translator')->get('Vérifié'); ?>" data-off="<?php echo app('translator')->get('Non Vérifié'); ?>"
                                    name="ev" <?php if($user->ev): ?> checked <?php endif; ?>>

                            </div>

                            <div class="form-group  col-xl-4 col-md-6 col-12">
                                <label><?php echo app('translator')->get('Mobile Vérification'); ?></label>
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                    data-bs-toggle="toggle" data-on="<?php echo app('translator')->get('Vérifié'); ?>" data-off="<?php echo app('translator')->get('Non Vérifié'); ?>"
                            ...
                            <div class="form-group col-xl-4 col-md- col-12">
                                <label><?php echo app('translator')->get('2FA Vérification'); ?> </label>
                                <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success"
                                    data-offstyle="-danger" data-bs-toggle="toggle" data-on="<?php echo app('translator')->get('Activer'); ?>"
                                    data-off="<?php echo app('translator')->get('Désactiver'); ?>" name="ts"
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button type="submit" class="btn btn--primary w-100 h-45"><?php echo app('translator')->get('Soumettre'); ?>
                                    </button>
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><span class="type"></span> <span><?php echo app('translator')->get('Solde'); ?></span></h5>
                ...
                <form action="<?php echo e(route('admin.users.add.sub.balance', $user->id)); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label><?php echo app('translator')->get('Montant'); ?></label>
                            <div class="input-group">
                                <input type="number" step="any" name="amount" class="form-control"
                                    placeholder="<?php echo app('translator')->get('Veuillez fournir un montant positi'); ?>" required>
                                <div class="input-group-text"><?php echo e(__($general->cur_text)); ?></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label><?php echo app('translator')->get('Remarque'); ?></label>
                            <textarea class="form-control" placeholder="<?php echo app('translator')->get('Remarque'); ?>" name="remark" rows="4" required></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <?php if($user->status == Status::USER_ACTIVE): ?>
                            <span><?php echo app('translator')->get('Utilisateur Banni'); ?></span>
                        <?php else: ?>
                            <span><?php echo app('translator')->get('Utilisateur débannir'); ?></span>
                        <?php endif; ?>
                    </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                ...
                <form action="<?php echo e(route('admin.users.status', $user->id)); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <?php if($user->status == 1): ?>
                            <h6 class="mb-2"><?php echo app('translator')->get('Si vous bannissez cet utilisateur, il ne pourra pas accéder à son tableau de bord.'); ?></h6>
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Raison'); ?></label>
                                <textarea class="form-control" name="reason" rows="4" required></textarea>
                            </div>
                        <?php else: ?>
                            <p><span><?php echo app('translator')->get('La raison de du banissement était'); ?>:</span></p>
                            <p><?php echo e($user->ban_reason); ?></p>
                            <h4 class="text-center mt-3"><?php echo app('translator')->get('Êtes-vous sûr de débannir cet utilisateur ?'); ?></h4>
                        <?php endif; ?>
                    </div>
                    <div class="modal-footer">
                        <?php if($user->status == Status::USER_ACTIVE): ?>
                        ...
                        <?php else: ?>
                            <button type="button" class="btn btn--dark"
                                data-bs-dismiss="modal"><?php echo app('translator')->get('Non'); ?></button>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zubqbcmf/app/core/resources/views/admin/users/detail.blade.php ENDPATH**/ ?>