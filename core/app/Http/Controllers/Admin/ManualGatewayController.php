...
class ManualGatewayController extends Controller
{
    ...
    {
        $pageTitle = 'Passerelles Manuelles';
    ...
    {
        $pageTitle = 'Modifier Passerelle Manuelle';
    ...
    public function store(Request $request)
    {
        ...
        $notify[] = ['success', $method->name . ' La passerelle manuelle a été ajoutée.'];
        return back()->withNotify($notify);
    }

    public function edit($alias)
    {
        $pageTitle = 'Nouvelle Passerelle Manuelle';
    ...
    public function update(Request $request, $code)
    {
        ...
        $notify[] = ['success', $method->name . 'Passerelle manuelle mise à jour avec succès'];
