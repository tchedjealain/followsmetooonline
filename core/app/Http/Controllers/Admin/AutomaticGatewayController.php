...
class AutomaticGatewayController extends Controller
{
    ...
    {
        $pageTitle = 'Passerelles Automatiques';
    ...
    public function edit($alias)
    {
        ...
        $pageTitle = 'Mise à jour Passerelle';
    ...
    public function update(Request $request, $code)
    {
        ...
        $notify[] = ['success', $gateway->name . ' Mise à jour réussie'];
    ...
    public function remove($id)
    {
        ...
        $notify[] = ['success', 'Devise de la passerelle supprimée'];
