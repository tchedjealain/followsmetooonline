...
class UserController extends Controller
{
    ...
    {
        $pageTitle       = 'Historique Des dépôts';
    ...
    public function create2fa(Request $request)
    {
        ...
        if ($response) {
            ...
            $user->save();
            $notify[] = ['success', 'L\'authentificateur Google a été activé avec succès'];
    ...
    public function disable2fa(Request $request)
    {
        ...
        if ($response) {
            ...
            $user->save();
            $notify[] = ['success', 'Authentificateur à deux facteurs désactivé avec succès'];
        } else {
            $notify[] = ['error', 'Mauvais code de vérification'];
        }
    ...
    public function userDataSubmit(Request $request)
    {
        ...
        $notify[] = ['success', 'Le processus d\'inscription s\'est terminé avec succès'];
