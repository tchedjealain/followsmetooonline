...
class AuthorizationController extends Controller
{
    ...
    public function authorizeForm()
    {
        ...
        if (!$user->status) {
            ...
            $type = 'email';
            $pageTitle = 'Vérifier Email';
            $notifyTemplate = 'EVER_CODE';
        } elseif (!$user->sv) {
            $type = 'sms';
            $pageTitle = 'Vérifier Numéro Téléphone';
    ...
    public function sendVerifyCode($type)
    {
        ...
        if ($this->checkCodeValidity($user)) {
            ...
            throw ValidationException::withMessages(['resend' => 'Veuillez essayer plustard ' . $delay . ' seconds']);
        }
        ...
        $notify[] = ['success', 'Code de vérification envoyé avec succès'];
    ...
    public function emailVerification(Request $request)
    {
        ...
        throw ValidationException::withMessages(['code' => 'Le code de vérification ne correspond pas !']);
    }
    ...
    public function g2faVerification(Request $request)
    {
        ...
        if ($response) {
            ...
            $notify[] = ['error', 'Mauvais code de vérification'];
        }
        return back()->withNotify($notify);
    }
}