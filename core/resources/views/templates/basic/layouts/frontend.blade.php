    ...
    <div class="privacy-area privacy-area--style">
        <div class="container">
            <div class="copyright-area d-flex align-items-center justify-content-center flex-wrap">
                <div class="copyright">
                    <p>@lang('FOLLOWMETOO COPYRIGHT') &copy; {{ date('Y') }} @lang('TOUS DROITS RÉSERVÉS')</p>
                </div>
            </div>
        </div>
    </div>
    ...
    @if ($cookie->data_values->status == Status::ENABLE && !\Cookie::get('gdpr_cookie'))
        ...
        <div class="cookies-card hide text-center">
            ...
            <p class="cookies-card__content mt-4">{{ $cookie->data_values->short_desc }} <a
                    class="link-text" href="{{ route('cookie.policy') }}" target="_blank">@lang('en savoir plus')</a></p>
            <div class="cookies-card__btn mt-4">
                <button class="btn submit-btn w-100 policy" type="button">@lang('J\'accepte')</button>
            </div>
        </div>
    @endif
