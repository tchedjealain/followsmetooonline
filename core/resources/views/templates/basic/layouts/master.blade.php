...
<head>
    ...
    <link href="{{ asset('assets/viseradmin/css/vendor/bootstrap-toggle.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/global/css/all.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/global/css/line-awesome.min.css') }}" rel="stylesheet">
    @stack('style-lib')
    <link href="{{ asset('assets/viseradmin/css/vendor/select2.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/viseradmin/css/app.css') }}" rel="stylesheet">
