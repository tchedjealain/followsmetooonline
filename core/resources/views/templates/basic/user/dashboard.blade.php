                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Solde')</span>
            ...
            <div class="card bg--success has-link box--shadow2">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Montant Dépensé')</span>
            ...
            <div class="card bg--danger has-link box--shadow2">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Transactions Totales')</span>
            ...
            <div class="card bg--purple has-link box--shadow2 overflow-hidden">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Service Total')</span>
            ...
            <div class="card bg--blue has-link box--shadow2">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Total des Dépôts')</span>
