                    ...
                    <form action="">
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <input class="datepicker-here form-control" name="date" data-range="true" data-multiple-dates-separator=" - " data-language="en" data-position='bottom right' type="text" value="{{ request()->date }}" placeholder="@lang('Date de début - Date de fin')" autocomplete="off">
                            </div>
...
@endsection
@push('style-lib')
    <link href="{{ asset('assets/viseradmin/css/vendor/datepicker.min.css') }}" rel="stylesheet">
@endpush
