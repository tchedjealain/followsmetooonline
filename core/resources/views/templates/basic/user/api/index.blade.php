                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline--primary confirmationBtn" data-question="@lang('Votre clé API actuelle sera supprimée. Êtes-vous sûr de générer une nouvelle clé API ?')" data-action="{{ route('user.api.generateKey') }}">
                                            @lang('Générer une nouvelle clé')
                                        </button>
                                    </td>
                                </tr>
