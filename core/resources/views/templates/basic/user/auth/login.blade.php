                    ...
                    <div class="row m-0 flex-wrap-reverse">
                        <div class="col-lg-6">
                            <div class="register-form-area common-form-style bg-one create-account">
                                <h4 class="title">@lang('Connectez-vous')</h4>
                                <form class="create-account-form register-form verify-gcaptcha" method="POST"
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-12 mb-3">
                                            <label class="form-label">@lang('Nom Utilisateur ou E-mail')</label>
                                            <input type="text" name="username" class="form--control"
                                                value="{{ old('username') }}" placeholder="@lang('Nom Uutilisateur ou E-mail')" required>
                                        </div>
                                        <div class="col-lg-12 mb-3">
                                            <label class="form-label">@lang('Mot De Passe')</label>
                                            <input id="password" type="password" class="form--control" name="password"
                                                required autocomplete="current-password" placeholder="@lang('Mot De Passe')">
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-3 text-center">
                                            <div class="checkbox-wrapper d-flex flex-wrap justify-content-between">
                                                <div class="checkbox-item">
                                                    ...
                                                    <label for="remember">@lang('Se Souvenir De Moi')</label>
                                                </div>


                                                <a href="{{ route('user.password.request') }}"
                                                    class="text--base">@lang('Mot De Passe Oublié ?')</a>

                                            </div>
                                        </div>

                                        <div class="col-lg-12">
                                            <button type="submit" class="submit-btn w-100">@lang('Connexion')</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="change-catagory-area">
                                ...
                                <a href="{{ route('user.register') }}"
                                    class="btn--base-active account-control-button">@lang('Créer un compte')</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function submitUserForm() {
            ...
            if (response.length == 0) {
                document.getElementById('g-recaptcha-error').innerHTML =
                    '<span style="color:red;">@lang('Le champ Captcha est obligatoire.')</span>';
                return false;
            }
            return true;
        }
