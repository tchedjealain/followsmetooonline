            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="common-form-style bg-one">
                        ...
                        <h4>
                            @lang('Pour récupérer votre compte, veuillez fournir votre adresse e-mail ou votre nom d\'utilisateur')
                        </h4>
                        <form method="POST" action="{{ route('user.password.email') }}">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn--base w-100 mt-3">@lang('Soumettre')</button>
                            </div>
                        </form>
