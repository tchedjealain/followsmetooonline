                    ...
                    <div class="row m-0">
                        <div class="col-lg-6 p-0">
                            <div class="change-catagory-area">
                                <h4 class="title">
                                    @lang('Vous avez déjà un compte?')
                                </h4>
                                <a href="{{ route('user.login') }}"
                                    class="btn--base-active account-control-button">@lang('Connectez-vous ici')</a>
                            </div>
                        </div>

                        <div class="col-lg-6 ">
                            <div class="register-form-area common-form-style bg-one create-account">
                                <h4 class="title">@lang('Créez votre compte')</h4>
                                <form action="{{ route('user.register') }}" method="POST" class="verify-gcaptcha">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label">@lang('Nom Utilisateur')</label>
                                                <input type="text" class="form-control form--control checkUser"
                                                    name="username" value="{{ old('username') }}" required
                                                    placeholder="@lang('Nom Utilisateur')">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="email" class="form-control form--control checkUser"
                                                    placeholder="@lang('Adresse E-Mail')" name="email"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label">@lang('Numéro Téléphone')</label>
                                                <div class="input-group ">
                                                    ...
                                                    <input type="number" name="mobile" value="{{ old('mobile') }}"
                                                        ...
                                                        placeholder="@lang('Numéro Téléphone')" required>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label class="form-label">@lang('Confirmez Mot De Passe')</label>
                                                <input type="password" class="form-control form--control"
                                                    name="password_confirmation" required placeholder="@lang('Confirmez Mot De Passe')">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <x-captcha />
                                    ...
                                    @if ($general->agree)
                                        <div class="form-group form-checkbox mb-3">
                                            <input type="checkbox" id="agree" @checked(old('agree'))
                                                name="agree" required>
                                            <label for="agree">@lang('Je suis d\'accord avec')</label>
                                    ...
                                    <div class="form-group mt-3">
                                        <button type="submit" id="recaptcha" class="btn btn--base w-100">
                                            @lang('Créer Un Compte')</button>
                                    </div>
                                    <p class="mt-3">@lang('Vous avez déjà un compte?')
