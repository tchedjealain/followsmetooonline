            ...
            <form action="{{ route('user.deposit.insert') }}" method="post">
                ...
                <div class="card custom--card">
                    <div class="card-header">
                        <h5 class="card-title">@lang('Dépôt Dans Le Compte')</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label class="form-label">@lang('Sélectionnez la passerelle')</label>
                        ...
                        <div class="form-group">
                            <label class="form-label">@lang('Montant')</label>
                        ...
                        <div class="mt-3 preview-details d-none">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item justify-content-between d-none in-site-cur">
                                    <span>@lang('En') <span class="method_currency"></span></span>
                                    <span class="final_amo fw-bold">0</span>
                                </li>
                                <li class="list-group-item justify-content-center crypto_currency d-none">
                                    <span>@lang('Conversion avec') <span class="method_currency"></span>
                                        @lang('et la valeur finale s\'affichera à l\'étape suivante')</span>
                                </li>
                            </ul>
                        </div>
                        <button type="submit" class="btn btn--primary w-100 mt-3">@lang('Soumettre')</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        (function($) {
            ...
            $('select[name=gateway]').change(function() {
                ...
                if (resource.currency != '{{ $general->cur_text }}') {
                    var rateElement =
                        `<span class="fw-bold">@lang('Taux de Conversion')</span> <span><span  class="fw-bold">1 {{ __($general->cur_text) }} = <span class="rate">${rate}</span>  <span class="method_currency">${resource.currency}</span></span></span>`;
