            ...
            <div class="row justify-content-center align-items-center ml-b-30">
                ...
                <div class="col-lg-6 mrb-30">
                    <div class="register-form-area">
                        <h3 class="title">@lang('Entrer en contact')</h3>
                        <form class="register-form verify-gcaptcha" method="post" action="">
                            @csrf
                            <div class="row justify-content-center ms-b-20">
                                <div class="col-lg-6 mb-3">
                                    <input name="name" type="text" class="form--control"
                                        placeholder="@lang('Votre Nom')" value="{{ $user ? $user->fullname : old('name') }}"
                                        {{ $user ? 'readonly' : '' }} required>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <input name="email" type="text" class="form--control"
                                        placeholder="@lang('Adresse E-mail')" value="{{ $user ? $user->email : old('email') }}"
                                        {{ $user ? 'readonly' : '' }} required>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <input name="subject" type="text" class="form--control"
                                        placeholder="@lang('Objet du message')" value="{{ old('subject') }}" required>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <textarea name="message" wrap="off" class="form--control" placeholder="@lang('Rédigez votre message')">{{ old('message') }}</textarea>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <x-captcha />
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" class="submit-btn w-100">@lang('Soumettre Maintenant')</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="row justify-content-center align-items-center ml-b-30">
                    <div class="col-lg-4 col-md-6 col-sm-8 text-center mrb-30">
                        <div class="contact-info-item">
                            ...
                            <h3 class="title">@lang('Adresse de bureau')</h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8 text-center mrb-30">
                        <div class="contact-info-item active">
                            ...
                            <h3 class="title">@lang('Adresse E-mail')</h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8 text-center mrb-30">
                        <div class="contact-info-item">
                            ...
                            <h3 class="title">@lang('Numéro De Téléphone')</h3>
