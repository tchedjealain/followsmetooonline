                ...
                <div class="row justify-content-center ml-b-30">
                    <div class="col-lg-8 mrb-30">
                        <div class="news-item">
                            ...
                            <div class="row gy-4 justify-content-between">
                                <div class="col-md-6 social-area">
                                    <h6 class="post__share__title text--base">@lang('Partage maintenant')</h6>
                        ...
                        @if (\App\Models\Extension::where('act', 'fb-comment')->where('status', 1)->first())
                            <div class="news-item">
                                <div class="news-content news-details-content">
                                    <h3 class="title">@lang('laissez un commentaire')</h3>
                                    <div class="fb-comments"
                                        data-href="{{ route('blog.details', [$blog->id, slug($blog->data_values->title)]) }}"
                                        data-numposts="5"></div>
                                </div>
                        ...
                        <div class="sidebar">
                            <div class="widget-box">
                                <div class="popular-widget-box">
                                    <h3 class="widget-title">@lang('Derniers Blogs')</h3>
