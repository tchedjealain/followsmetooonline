                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mrb-30">
                            <div class="news-item">
                                <div class="news-thumb">
                                    <img src="{{ getImage('assets/images/frontend/blog/thumb_' . @$item->data_values->image, '480x280') }}" alt="@lang('blog')">
                                </div>
                                <div class="news-content">
                                    ...
                                    <div class="news-btn">
                                        <a class="custom-btn" href="{{ route('blog.details', [$item->id, slug($item->data_values->title)]) }}">@lang('EN SAVOIR PLUS') <i class="las la-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
