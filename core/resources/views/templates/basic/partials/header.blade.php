                    ...
                    <nav class="navbar navbar-expand-lg p-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav main-menu ms-auto">
                                <li><a href="{{ route('home') }}">@lang('Accueil')</a></li>
                                ...
                                <li class="menu_has_children">
                                    <a href="#0">@lang('Compte')</a>
                                    <ul class="sub-menu">
                                        @auth
                                            <li><a href="{{ route('user.home') }}">@lang('Tableau De Bord')</a></li>
                                            <li><a href="{{ route('user.logout') }}">@lang('Déconnexion')</a></li>
                                        @else
                                            <li><a href="{{ route('user.login') }}">@lang('Connexion')</a></li>
                                            <li><a href="{{ route('user.register') }}">@lang('S\'inscrire')</a></li>
                                        @endauth
                                    </ul>
                                </li>
                                @if ($general->ln)
