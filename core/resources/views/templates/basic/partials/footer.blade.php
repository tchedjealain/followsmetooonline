              ...
              <div class="row gy-4">
                  <div class="col-lg-4 col-sm-8">
                      <div class="footer-widget widget-menu">
                          <div class="footer-logo">
                              <h3 class="widget-title">@lang('A Propos')</h3>
                  ...
                  <div class="col-lg-2 col-sm-6">
                      <div class="footer-widget">
                          <h3 class="widget-title">@lang('Liens Rapides')</h3>
                          <ul>
                              @foreach ($pages as $data)
                                  <li><a href="{{ route('pages', [$data->slug]) }}">{{ __($data->name) }}</a></li>
                              @endforeach
                              <li><a href="{{ route('contact') }}">@lang('Contact')</a></li>
                              <li><a href="{{ route('api.documentation') }}">@lang('Documentation API')</a></li>
                          </ul>
                      </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                      <div class="footer-widget">
                          <h3 class="widget-title">@lang('Politiques')</h3>
                          <ul>
                              @php
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="footer-widget widget-menu">
                          ...
                          <ul class="footer-contact-list">
                              ...
                              <li>@lang('Appellez') {{ @$addressContent->data_values->phone }}</li>
                              <li><a
