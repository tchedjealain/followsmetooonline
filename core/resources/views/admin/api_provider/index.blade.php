                                        ...
                                        <td>
                                            ...
                                            @if ($apiProvider->status == Status::DISABLE)
                                                <button type="button"
                                                    ...
                                                    data-question="@lang('Êtes-vous sûr d\'avoir activé cette API ?')">
                                            ...
                                            @else
                                                <button type="button"
                                                    ...
                                                    data-action="{{ route('admin.api.provider.status', $apiProvider->id) }}"
                                                    data-question="@lang('Êtes-vous sûr de désactiver cette API ?')">
...
@push('breadcrumb-plugins')
    ...
    <button class="btn btn-outline--primary h-45 btn-sm addApi"><i class="las la-plus"></i> @lang('Ajouter Nouveau')</button>
@endpush
    ...
    <script>
        (function($) {
            ...
            $('.addApi').on('click', function() {
                let modal = $('#addApiModal');
                let title = "@lang('Ajout Nouveau Api')";
