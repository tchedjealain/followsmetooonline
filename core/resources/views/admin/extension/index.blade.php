...
@section('panel')
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button"
                                                    ...
                                                    <i class="la la-cogs"></i> @lang('Configuré')
                                                </button>
                                                <button type="button"
                                                    ...
                                                    <i class="la la-question"></i> @lang('Aide')
                                                </button>
                                                @if ($extension->status == Status::DISABLE)
                                                    <button type="button"
                                                        ...
                                                        data-question="@lang('Êtes-vous sûr de vouloir activé cette extension ?')">
                                                ...
                                                @else
                                                    <button type="button"
                                                        ...
                                                        data-action="{{ route('admin.extensions.status', $extension->id) }}"
                                                        data-question="@lang('Êtes-vous sûr de vouloir désactivé cette extension')">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Mettre à jour l\'extension'): <span class="extension-name"></span></h5>
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--primary w-100 h-45"
                            id="editBtn">@lang('Soumettre')</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="helpModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Besoin D\'aide')?</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                    </button>
                </div>
