                ...
                <form action="{{ route('admin.gateway.automatic.update', $gateway->code) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="payment-method-item block-item">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="input-group d-flex flex-wrap justify-content-end width-375">
                                                <select class="newCurrencyVal ">
                                                    <option value="">@lang('Sélectionner une devise')</option>
                                                    @forelse($supportedCurrencies as $currency => $symbol)
                                                        <option value="{{ $currency }}"
                                                            data-symbol="{{ $symbol }}">{{ __($currency) }} </option>
                                                    @empty
                                                        <option value="">@lang('Support de devise non disponible')</option>
                                                    @endforelse
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-name="{{ $gateway->name }}">@lang('Ajouter Nouveau')</button>
                                            </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button type="button" class="copyInput input-group-text"
                                                        title="@lang('Copie')"><i class="fa fa-copy"></i></button>
                                                </div>
                            ...
                            @endif
                            <div class="payment-method-body mt-2">
                                <h4 class="mb-3">@lang('Réglage Global pour') {{ __($gateway->name) }}</h4>
                                <div class="row">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn--danger confirmationBtn"
                                                        data-question="@lang('Voulez-vous vraiment supprimer cette devise de passerelle ?')"
                                                        data-action="{{ route('admin.gateway.automatic.remove', $gatewayCurrency->id) }}">
                                                        <i class="la la-trash-o me-2"></i>@lang('Supprimer')
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary mt-2">
                                                    <h5 class="card-header bg--primary">@lang('Plage')</h5>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label>@lang('Montant Minimum')</label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control"
                                                                    name="currency[{{ $currencyIndex }}][min_amount]"
                                                                    value="{{ getAmount($gatewayCurrency->min_amount) }}"
                                                                    required />
                                                                <div class="input-group-text">{{ __($general->cur_text) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>@lang('Montant Maximum')</label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control"
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary mt-2">
                                                    <h5 class="card-header bg--primary">@lang('Frais')</h5>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label>@lang('Frais Fixe')</label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            <label>@lang('Frais en Pourcentage')</label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control"
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary mt-2">
                                                    <h5 class="card-header bg--primary">@lang('Devise')</h5>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>@lang('Devise')</label>
                                                                    <input type="text"
                        ...
                        <div class="payment-method-item child--item newMethodCurrency d-none">
                            ...
                            <div class="payment-method-header">
                                ...
                                <div class="content w-100 ps-0">
                                    <div class="d-flex justify-content-between">
                                        <div class="form-group">
                                            <h4 class="mb-3" id="payment_currency_name">@lang('Nom')</h4>
