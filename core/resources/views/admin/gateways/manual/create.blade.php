                                ...
                                <div class="row mb-none-15">
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                        <div class="form-group">
                                            <label>@lang('Nom De La Passerelle')</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>@lang('Montant Minimal')</label>
                                                    <div class="input-group">
                                                        <input type="number" step="any" class="form-control"
                                                            name="min_limit" required value="{{ old('min_limit') }}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="any" class="form-control"
                                                            name="max_limit" required value="{{ old('max_limit') }}" />
                                                        <div class="input-group-text">{{ __($general->cur_text) }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg--primary">@lang('Instruction De Dépôt')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            <div class="card-header bg--primary d-flex justify-content-between">
                                                <h5 class="text-white">@lang('Données D\'utilisateur')</h5>
                                                <button type="button"
                                                    class="btn btn-sm btn-outline-light float-end form-generate-btn"> <i
                                                        class="la la-fw la-plus"></i>@lang('Ajouter Nouveau')</button>
                                            </div>
                                            <div class="card-body">
