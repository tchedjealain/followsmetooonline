    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.category.index') }}">
                    <a href="{{ route('admin.category.index') }}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Catégorie')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.orders*', 3) }}">
                        ...
                        <span class="menu-title">@lang('Gestion Commande')</span>
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.orders.index') }} ">
                                <a href="{{ route('admin.orders.index') }}" class="nav-link">
                                    ...
                                    <span class="menu-title">@lang('Toutes Les Cmd')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.orders.pending') }}">
                                <a href="{{ route('admin.orders.pending') }}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Cmd En Attente')</span>
                                    @if ($pendingOrders)
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.orders.processing') }}  ">
                                <a href="{{ route('admin.orders.processing') }}" class="nav-link  ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Cmd Encours')</span>
                                    @if ($processingOrders)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $processingOrders }}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item  {{ menuActive('admin.orders.completed') }}">
                                <a href="{{ route('admin.orders.completed') }}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Cmd Terminées')</span>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.orders.cancelled') }} ">
                                <a href="{{ route('admin.orders.cancelled') }}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Cmd Annulées')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item  {{ menuActive('admin.orders.refunded') }}">
                                <a href="{{ route('admin.orders.refunded') }}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Cmd Retournées')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.users*', 3) }}">
                        ...
                        <span class="menu-title">@lang('Gestion Utilisateur')</span>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.gateway*', 3) }}">
                        ...
                        <span class="menu-title">@lang('Passerelles Paiement')</span>
                    </a>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.gateway.automatic.*') }} ">
                                <a href="{{ route('admin.gateway.automatic.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Passerelle Automatique')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.gateway.manual.*') }} ">
                                <a href="{{ route('admin.gateway.manual.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Passerelle Manuelle')</span>
                                </a>
                            </li>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.pending') }} ">
                                <a href="{{ route('admin.deposit.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Dépôts En Attente')</span>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.approved') }} ">
                                <a href="{{ route('admin.deposit.approved') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Dépôts Approuvés')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.successful') }} ">
                                <a href="{{ route('admin.deposit.successful') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Dépôts Réussis')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.rejected') }} ">
                                <a href="{{ route('admin.deposit.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Dépôts Rejetés')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.initiated') }} ">
                                ...
                                <a href="{{ route('admin.deposit.initiated') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Dépôts Initiés')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.list') }} ">
                                <a href="{{ route('admin.deposit.list') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Tous Les Dépôts')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.ticket.closed') }} ">
                                <a href="{{ route('admin.ticket.closed') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Fermé Ticket')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.ticket.answered') }} ">
                                <a href="{{ route('admin.ticket.answered') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Réponse Ticket')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.ticket.index') }} ">
                                <a href="{{ route('admin.ticket.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Tout Les Tickets')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul>
                            <li
                                ...
                                <a href="{{ route('admin.report.transaction') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Historique Transaction')</span>
                                </a>
                            </li>
                            ...
                            <li
                                ...
                                <a href="{{ route('admin.report.login.history') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Historique Connexion')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.notification.history') }}">
                                <a href="{{ route('admin.report.notification.history') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Historique Notification')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar__menu-header">@lang('Paramètres')</li>
                <li class="sidebar-menu-item {{ menuActive('admin.setting.index') }}">
                    <a href="{{ route('admin.setting.index') }}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Réglage Général')</span>
                    </a>
                </li>
            ...
            <div class="text-center mb-3 text-uppercase">
                <span class="text--primary">@lang('FOLLOWMETOO')</span>
