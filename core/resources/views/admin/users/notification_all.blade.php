            ...
            <div class="card">
                <form action="" class="notify-form">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn w-100 h-45 btn--primary me-2">@lang('Soumettre')</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text--danger text-center">@lang('Ne fermez pas ou n\'actualisez pas la fenêtre avant la fin')</h4>
                    ...
                    <div class="mt-3">
                        ...
                        <p>@lang('Email sent') <span class="sent">0</span> @lang('utilisateurs hors de') {{ $users }}
                            @lang('utilisateurs')</p>
                    </div>
                </div>
            </div>
...
@push('breadcrumb-plugins')
    ...
    <span class="text--primary">@lang('La notification sera envoyée via ') @if ($general->en)
            <span class="badge badge--warning">@lang('E-mail')</span>
            @endif @if ($general->sn)
