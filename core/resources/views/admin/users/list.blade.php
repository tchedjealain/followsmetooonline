                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Email-Numéro')</th>
                                    <th>@lang('Pays')</th>
                                    <th>@lang('Inscrit le')</th>
                                    <th>@lang('Solde')</th>
                                    <th>@lang('Action')</th>
                                </tr>
                            </thead>
                                ...
                                @forelse($users as $user)
                                    <tr>
                                        <td>
                                            ...
                                            <span class="small">
                                                <a
                                                    href="{{ route('admin.users.detail', $user->id) }}"><span>@</span>{{ __($user->username) }}</a>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.users.detail', $user->id) }}"
                                                ...
                                                <i class="las la-desktop"></i> @lang('Détails')
                                            </a>
                                        </td>
...
@push('breadcrumb-plugins')
    <x-search-form placeholder="Nom Utlisateur / E-mail" />
@endpush
