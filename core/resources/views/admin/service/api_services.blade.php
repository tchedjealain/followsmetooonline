...
@section('panel')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('Entrez combien de fois vous augmentez le prix')</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn--primary w-100 h-45" id="allService">@lang('Soumettre')</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">@lang('Ajouter Nouveau')</h4>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
...
@push('breadcrumb-plugins')
    <div class="select-all">
        <div class="select-all__content d-flex align-items-center flex-wrap">
            <label for="selectAll" class="select-all__text mb-0 me-2">@lang('Sélectionnez Tout')</label>
    ...
    <button class="btn btn-outline--info btn-sm d-none h-45 addService" data-bs-toggle="modal"
        ...
        <i class="las la-plus"></i>
        @lang('Ajouter Le Service Sélectionné')
    </button>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success) {
                            ...
                            notify('error', `@lang('Quelque chose s\'est mal passé, veuillez réessayer.')`);
                        }
