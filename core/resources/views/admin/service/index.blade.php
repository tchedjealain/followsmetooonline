                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.service.edit', $service->id) }}"
                                                ...
                                                <i class="la la-pen"></i> @lang('Modifier')
                                            </a>
                                            @if ($service->status == Status::DISABLE)
                                                <button type="button"
                                                    class="btn btn-sm btn-outline--success confirmationBtn"
                                                    data-action="{{ route('admin.service.status', $service->id) }}"
                                                    data-question="@lang('Êtes-vous sûr de vouloir activé ce service?')">
                                            ...
                                            @else
                                                <button type="button"
                                                    ...
                                                    data-action="{{ route('admin.service.status', $service->id) }}"
                                                    data-question="@lang('Êtes-vous sûr de vouloir désactivé ce service?')">
