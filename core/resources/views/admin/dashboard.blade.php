    ...
    <div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-end">
                                <span class="text--small text-white">@lang('Utilisateurs Total')</span>
                ...
                <div class="card bg--success has-link box--shadow2">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-end">
                                <span class="text--small text-white">@lang('Utilisateurs Actif')</span>
                ...
                <div class="card bg--danger has-link box--shadow2">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-end">
                                <span class="text--small text-white">@lang('Email Non Vérifié Users')</span>
                ...
                <div class="card bg--red has-link box--shadow2">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-end">
                                <span class="text--small text-white">@lang('Mobile Non Vérifié Users')</span>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p>@lang('Dépôt Total')</p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border--success btn-outline--success border border" href="{{ route('admin.deposit.list') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p>@lang('Dépôts En Attente')</p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border--warning btn-outline--warning border border" href="{{ route('admin.deposit.pending') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p>@lang('Dépôts Rejetés')</p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border--danger btn-outline--danger border border" href="{{ route('admin.deposit.rejected') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <p>@lang('Frais De Dépôt')</p>
                    </div>
                    <a class="widget-two__btn border--primary btn-outline--primary border--primary btn-outline--primary border border" href="{{ route('admin.deposit.list') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
        </div><!-- row end-->
        ...
        <div class="row gy-4 mt-2">
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--primary btn-outline--primary border" href="{{ route('admin.orders.index') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--warning btn-outline--warning border" href="{{ route('admin.orders.pending') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--info btn-outline--info border" href="{{ route('admin.orders.processing') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
        ...
        <div class="row gy-4 mt-2">
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--success btn-outline--success border" href="{{ route('admin.orders.completed') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--danger btn-outline--danger border" href="{{ route('admin.orders.cancelled') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
            <div class="col-xxl-4 col-sm-6">
                <div class="widget-two box--shadow2 b-radius--5 bg--white">
                    ...
                    <a class="widget-two__btn border--secondary btn-outline--secondary border" href="{{ route('admin.orders.refunded') }}">@lang('Voir Tout')</a>
                </div>
            </div><!-- dashboard-w1 end -->
        </div>
        <div class="row mb-none-30 mt-30">
            <div class="col-xl-6 mb-30">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('Dépôt Mensuel') (@lang('12 Derniers Mois'))</h5>
            ...
            <div class="col-xl-6 mb-30">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('Transactions Report') (@lang('30 Derniers Jours'))</h5>
        ...
        <div class="row mb-none-30 mt-5">
            <div class="col-xl-4 col-lg-6 mb-30">
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <h5 class="card-title">@lang('Conexion Par Browser') (@lang('30 Dern. Jours'))</h5>
            ...
            <div class="col-xl-4 col-lg-6 mb-30">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('Connexion Par Pays') (@lang('30 Derniers Jours'))</h5>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">@lang('Instruction de réglage de la tâche Cron')</h5>
                        <button class="close" data-bs-dismiss="modal" type="button" aria-label="Close">
                            <i class="las la-times"></i>
                        </button>
                    </div>
                    <div class="modal-body">
                        <h3 class="text--danger text-center">@lang('Veuillez Définir La Tâche Cron Maintenant')</h3>
                        <p class="lead">
                            @lang('Pour automatiser le placement de la commande API, nous devons définir la tâche cron et nous assurer que la tâche cron s\'exécute correctement. Réglez le temps de Cron au minimum possible. Une fois toutes les 5 à 15 minutes est idéale, tandis qu\'une fois toutes les minutes est la meilleure option.') </p>
